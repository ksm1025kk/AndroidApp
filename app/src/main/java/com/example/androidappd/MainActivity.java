package com.example.androidappd;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 여기에 코드를 넣어놓으면 화면이 처음 실행될 때 동작할 코드가 됨
        super.onCreate(savedInstanceState);     // AppCompatActivity 부모 클래스의 onCreate 메서드를 실행
        setContentView(R.layout.activity_main);     // res 폴더안에 Lagout 폴더 안에 activity_main
